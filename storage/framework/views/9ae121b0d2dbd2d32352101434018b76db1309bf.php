...
<head>
    ...
    <title>Clienbot | Restablecimiento de Contraseña</title>
...
<body class="hold-transition register-page" ng-controller="registerCtrl">
    <div class="register-box">
        ...
        <div class="register-box-body">
            <p class="login-box-msg">Introduzca su nueva contrasena de Clienbot</p>
            <form ng-submit="changePassword()">
                <div class="form-group has-feedback">
                    <input type="password" class="form-control" placeholder="Escriba su nueva contraseña" ng-model="data.password">
                    <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
                </div>
                <div class="form-group has-feedback">
                    <input type="password" class="form-control" placeholder="Repita su contraseña" ng-model="data.c_password">
                    <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
                </div>
