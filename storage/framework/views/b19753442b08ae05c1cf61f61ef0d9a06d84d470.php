...
<body style="border: 1px solid #222d32; background: #222d32">
	...
	<div style="font-size: 15px;background: white; padding:10px;margin-top: -60px;">
		...
		<p>Estas son tus credenciales de Ingreso</p>
		<p>Nombre de usuario: <?php echo e($mail_address); ?></p>
		<p>Clave: <?php echo e($password); ?></p>
		<p>Haz clic en el siguiente enlace para aceptar la solicitud</p>
		<a href="http://localhost/clienbot/panel/final/account.html?token=<?php echo e($token); ?>">http://localhost/clienbot/panel/account.html?token=<?php echo e($token); ?></a>
	</div>
	<hr>
